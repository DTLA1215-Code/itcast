...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "YgNXquVVM9yqAEX6tXmXenhm8G5xfUAeiiZlvGW4";
    private static final String SECRETKEY = "mAZFUhzCBN4fb3_OmhpkvhkHej8YkEmGsiP8go5E";
    private static final String BUCKET = "itheima-repository";
    public static final String DOMAIN= "http://qceuydl3e.bkt.clouddn.com/";

    public static void main(String[] args) {
//        uploadFile("C:\\Users\\And Jaune Pyrrha\\Desktop\\file\\1.jpg","1.jpg");
//        removeFiles("1.jpg","1.jpg");
    }
