...
public class MessageConstant {
    ...
    public static final String CHECKGROUP_IN_USE = "删除组失败，因为此项已被使用";
    public static final String CHECKITEM_IN_USE = "删除项失败，因为此项已被使用";
    ...
    public static final String SENT_VALIDATECODE = "验证码已经发送过，请注意查收";
